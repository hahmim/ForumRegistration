	...
	<table>
		...
		<tr>
			...
			<td><form:select path="country">
				...
				<form:option value="1" label="Algeria" />
				<form:option value="2" label="USA" />
				<form:option value="3" label="France" />
			</form:select></td>
		</tr>
		<tr>
			<td>About you :</td>
		...
		<tr>
			...
			<form:checkbox path="community" value="AWS" label="AWS" />
			<form:checkbox path="community" value="Docker" label="Docker" />
			<form:checkbox path="community" value="Ansible" label="Ansible" />
			</td>
		</tr>
		<tr>
